  ...
  return (
    <main className="flex flex-col space-y-3 items-center justify-center w-full h-full">
      <div className="w-[20%] flex justify-between">
        <button className="transition-all bg-linear-to-r from-[#F9D849] to-[#FFE883] cursor-pointer rounded-sm w-20 h-7 shadow-s2 font-bold hover:scale-108" onClick={() => setMode(true)}>Register</button>
        <button className="transition-all bg-linear-to-r from-[#F9D849] to-[#FFE883] cursor-pointer rounded-sm w-20 h-7 shadow-s2 font-bold hover:scale-108" onClick={() => setMode(false)}>Login</button>
      </div>
      {Mode == true ? (
